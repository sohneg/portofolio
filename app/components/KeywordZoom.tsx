...
const items: KW[] = [
  ...
  { text: 'Golang', row: 1, col: 1, start: 0.19, duration: 0.08 },
  { text: 'C#', row: 3, col: 3, start: 0.23, duration: 0.08 },
  { text: 'C++', row: 4, col: 1, start: 0.26, duration: 0.08 },
  { text: 'Angular', row: 1, col: 4, start: 0.24, duration: 0.08 },
  { text: 'ASP.NET', row: 2, col: 1, start: 0.27, duration: 0.08 },
  { text: 'Unity', row: 3, col: 2, start: 0.25, duration: 0.08 },
  { text: 'Docker', row: 4, col: 4, start: 0.29, duration: 0.08 },
  { text: 'Claude Code', row: 1, col: 3, start: 0.31, duration: 0.08 },
  { text: 'MCP', row: 2, col: 3, start: 0.28, duration: 0.08 },
  { text: 'VR', row: 1, col: 1, start: 0.33, duration: 0.08 },
  { text: 'FreeSWITCH', row: 3, col: 4, start: 0.3, duration: 0.08 },
  ...
  // Projekte
  { text: 'Tuning Schweiz', row: 3, col: 2, start: 0.35, duration: 0.08 },
  { text: 'Dice of Fate', row: 1, col: 2, start: 0.38, duration: 0.08 },
  { text: 'Alpineers', row: 4, col: 3, start: 0.36, duration: 0.08 },
  { text: 'Crow Desk', row: 2, col: 1, start: 0.39, duration: 0.08 },
  { text: 'Games', row: 4, col: 4, start: 0.4, duration: 0.08 },
  { text: '9000+', row: 1, col: 3, start: 0.37, duration: 0.08 },
  { text: 'Brabender', row: 2, col: 2, start: 0.32, duration: 0.08 },
  // Infra
  { text: 'Hetzner', row: 3, col: 1, start: 0.41, duration: 0.08 },
  { text: 'Hosting', row: 4, col: 2, start: 0.42, duration: 0.08 },
  { text: 'Server', row: 1, col: 4, start: 0.43, duration: 0.08 },
  // Leben
  { text: 'Sonex', row: 3, col: 3, start: 0.45, duration: 0.08 },
  { text: 'VRChat', row: 2, col: 3, start: 0.46, duration: 0.08 },
  { text: 'Ari & Luci', row: 4, col: 1, start: 0.47, duration: 0.08 },
  { text: 'Cookies', row: 1, col: 4, start: 0.48, duration: 0.08 },
  { text: 'Kreativ', row: 3, col: 4, start: 0.42, duration: 0.08 },
  { text: 'Community', row: 2, col: 2, start: 0.36, duration: 0.08 },
  { text: 'Musik', row: 4, col: 3, start: 0.44, duration: 0.09 },
  { text: 'Leidenschaft', row: 1, col: 1, start: 0.46, duration: 0.08 },
  { text: 'Pomsky', row: 3, col: 2, start: 0.49, duration: 0.08 },
  { text: 'Raspberry Pi', row: 2, col: 1, start: 0.38, duration: 0.08 },
]
